...
(function initLoadingScreen() {
    ...
    function startLoadingAnimation() {
        ...
        const alternativeTexts = {
            precision: {
                QUANTUM: "MEASUREMENT", PARTICLES: "ELECTRONS", ATOMS: "NUCLEI",
                ENERGY: "WAVES", MATTER: "FORMS", "&": "⚛", SPACE: "TIME",
                EXPERIMENT: "PROCEDURE", DISCOVERY: "RESULTS", EVIDENCE: "DATA",
                THE: "OUR", RESEARCH: "EMPIRICAL", PROCESS: "METHOD",
                IS: "DEMANDS", REVOLUTIONARY: "EXACT", S: "STUDY",
                C: "CALCULATE", I: "INSTRUMENT", E: "EXAMINE", N: "NUMERICAL",
                "TO TRUTH": "TO FACTS", "OBSERVE NATURE": "MEASURE PHENOMENA",
                "VERIFY DATA": "CONFIRM RESULTS", "TEST HYPOTHESES": "CONDUCT TESTS",
                "CHALLENGE THEORIES": "REFINE MODELS", LOGIC: "MATHEMATICS",
                REASON: "COMPUTATION", ANALYSIS: "QUANTITATIVE",
                INNOVATION: "BREAKTHROUGH", KNOWLEDGE: "UNDERSTANDING",
                EVOLVE: "REFINE", DISCOVER: "CALCULATE", PRECISION: "ACCURACY"
            },
            analysis: {
                QUANTUM: "BEHAVIOR", PARTICLES: "INTERACTION", ATOMS: "STRUCTURE",
                ENERGY: "POTENTIAL", MATTER: "COMPOSITION", "&": "∞",
                SPACE: "DIMENSION", EXPERIMENT: "OBSERVATION", DISCOVERY: "INSIGHT",
                EVIDENCE: "PATTERN", THE: "THE", RESEARCH: "INVESTIGATION",
                PROCESS: "EXAMINATION", IS: "REVEALS", REVOLUTIONARY: "COMPLEX",
                S: "STUDY", C: "CORRELATE", I: "INTERPRET", E: "EVALUATE",
                N: "NUCLEATE", "TO TRUTH": "TO CAUSE",
                "OBSERVE NATURE": "STUDY SYSTEMS", "VERIFY DATA": "VALIDATE SETS",
                "TEST HYPOTHESES": "EXAMINE MODELS", "CHALLENGE THEORIES": "QUESTION LAWS",
                LOGIC: "REASON", REASON: "EVIDENCE", ANALYSIS: "SYNTHESIS",
                INNOVATION: "PARADIGM", KNOWLEDGE: "INSIGHT", EVOLVE: "PROGRESS",
                DISCOVER: "UNDERSTAND"
            },
            discovery: {
                QUANTUM: "REVOLUTION", PARTICLES: "PHYSICS", ATOMS: "THEORY",
                ENERGY: "UNIVERSE", MATTER: "CREATION", "&": "√", SPACE: "COSMOS",
                EXPERIMENT: "TRIAL", DISCOVERY: "WONDER", EVIDENCE: "PROOF",
                THE: "ALL", RESEARCH: "QUEST", PROCESS: "JOURNEY",
                IS: "UNLOCKS", REVOLUTIONARY: "TRANSFORMATIVE", S: "SEEK",
                C: "CREATE", I: "INSPIRE", E: "EXPLORE", N: "NURTURE",
                "TO TRUTH": "TO REALITY", "OBSERVE NATURE": "EMBRACE WONDER",
                "VERIFY DATA": "CONFIRM BELIEFS", "TEST HYPOTHESES": "PROVE CONCEPTS",
                "CHALLENGE THEORIES": "PIONEER IDEAS", LOGIC: "SYNTHESIS",
                REASON: "INTUITION", ANALYSIS: "REVELATION",
                INNOVATION: "EVOLUTION", KNOWLEDGE: "WISDOM",
                EVOLVE: "TRANSFORM", DISCOVER: "REVOLUTIONIZE",
        ...
        function animateExpandingRectangle() {
            ...
            const mainContent = document.querySelector(".main-content .sliced-container");
            const kineticType = document.getElementById("kinetic-type");
        ...
        // Activate first row
        const firstRow = document.querySelector(`.text-row[data-row-id="${rowIds[0]}"]`);
        if (firstRow) {
